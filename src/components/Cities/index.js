        ...
        <Col lg={24} md={24} sm={24} xs={24}>
          <Slide left>
            ...
            <div className="villes-block">
              ...
              <S.Content>
                <strong>{ville2}</strong> : {ville2_description}
                <span className="realistic-marker-highlight">{highlight4}</span>
                {ville2_description2}
                <span className="realistic-marker-highlight">{highlight5}</span>
                {ville2_description3}
                <span className="realistic-marker-highlight">{highlight7}</span>
                {ville2_description4}
              </S.Content>
              <S.Content>
                <strong>{ville3}</strong> : {ville3_description}
                <span className="realistic-marker-highlight">{highlight6}</span>
              </S.Content>
            </div>
            <Button
              onClick={() =>
                window.open("https://www.conjonction-fonciere.com", "_blank")
              }
            >
