...
const CitiesBlock = ({ icon, t, id, ville, highlight, highlight2, highlight3, highlight4, highlight5, highlight6, ville2, ville3, ville_description, ville2_description, ville2_description2, ville2_description3, ville3_description, ville3_description2}) => {
    const scrollTo = (id) => {
